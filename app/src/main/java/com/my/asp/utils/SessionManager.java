...
public class SessionManager {
  ...
  private int PRIVATE_MODE =0;
    ...
    @RequiresApi(api = Build.VERSION_CODES.GINGERBREAD)
    public void saveOrderNumber(String id){

        editor = preferences.edit();
        editor.putString(KEY_OrderNumber, id);
        editor.apply();
    ...
    public String getProductId(){
        String userID = preferences.getString(KEY_ProductId,"");
        return userID;
    }

    public String getOrderNumber(){
        String userID = preferences.getString(KEY_OrderNumber,"");
        return userID;
    }
